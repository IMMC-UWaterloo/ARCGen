...
%% Generate corridors, check cell array
nResample = 100;
xlimits = [0,2.0];
ylimits = [0,160];
% Load data
...
inputCellArray = struct2cell(rmfield(responseCurves,'specId'));

[charAvgNorm, innCorrNorm, outCorrNorm,proCurveDataNorm] = ...
    arcgen(inputCellArray,...
    'Diagnostics', 'off',...
    'nResamplePoints', nResample,...
    'NormalizeSignals', 'on',...
    'handleOutliers', 'off',...
...
%% Generate corridors, check structure without specId
nResample = 100;
xlimits = [0,2.0];
ylimits = [0,160];
% Load data
...
responseCurves = rmfield(responseCurves,'specId');

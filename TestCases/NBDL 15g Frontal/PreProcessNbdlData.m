...
data = readmatrix('15g Frontal.xlsx','sheet',sheetNames{iSheet});
...
save(['NBDL 15g Frontal - ' sheetNames{iSheet} '.mat'], 'responseCurves')
save(['NBDL 15g Frontal - ' sheetNames{iSheet} '_PointWiseAvg.mat'],...

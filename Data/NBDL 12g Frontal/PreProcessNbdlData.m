...
data = readmatrix('12g Frontal.xlsx','sheet',sheetNames{iSheet});
...
save(['NBDL 12g Frontal - ' idNames{iSheet} '.mat'], 'responseCurves')
save(['NBDL 12g Frontal - ' idNames{iSheet} '_PointWiseAvg.mat'],...
